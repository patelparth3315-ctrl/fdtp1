    ...
    <footer className="bg-[#0F1820] text-white pt-20 relative overflow-hidden flex flex-col items-center text-center font-montserrat border-t border-white/5">
      <div className="w-full max-w-6xl mx-auto px-6 relative z-10 flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-8 px-4">
          <h2 className="text-lg md:text-xl font-bold tracking-widest text-white mb-2 uppercase">{companyName}</h2>
          <p className="text-zinc-500 text-[11px] font-bold tracking-widest mb-5 uppercase">{cin}</p>
          <p className="text-zinc-400 text-xs md:text-sm font-medium leading-relaxed max-w-xl text-center">
            {address}
          </p>
        </div>

        {/* Contact Links */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 md:gap-12 mb-10 text-zinc-300 text-[13px] md:text-[14px] font-medium tracking-wide">
        ...
        <div className="bg-[#1E293B]/40 border border-white/5 rounded-[32px] px-8 py-3.5 flex items-center gap-6 mb-20 shadow-2xl">
          <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform shadow-md">
          ...
          <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform shadow-md">
            <svg viewBox="0 0 24 24" className="w-5 h-5 text-[#E4405F]" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
          </a>
          <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform shadow-md">
          ...
          <a href="#" className="w-10 h-10 rounded-full bg-white flex items-center justify-center hover:scale-110 transition-transform shadow-md">
            <svg viewBox="0 0 24 24" className="w-5 h-5 text-[#FF0000]" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
          </a>
        </div>

        {/* One Trip At A Time Branding Slogan */}
        <div className="mb-12 select-none pointer-events-none opacity-40">
          <p className="font-montserrat font-light text-[11px] md:text-[13px] tracking-[0.25em] uppercase text-white/80">
            One Trip At A Time.
          </p>
        </div>
      </div>
      ...
      <div className="w-full relative z-10 flex flex-col items-center mt-auto">
        <div 
          className="w-full h-24 bg-repeat-x bg-bottom pointer-events-none opacity-60 transition-opacity duration-500"
          style={{ 
            backgroundImage: `url('https://www.wanderon.in/svg/footer-skyline.svg')`,
            backgroundSize: 'auto 100%',
            filter: 'invert(1) brightness(0.9) opacity(0.65)'
          }}
        />
        ...
        <div className="w-full border-t border-white/10 bg-[#090F14]">
          <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left relative">
            ...
            <button 
              ...
              className="w-10 h-10 rounded-full bg-[#1E293B]/60 border border-white/10 flex items-center justify-center text-white hover:bg-primary-orange hover:text-white transition-all shadow-lg active:scale-95"
            >
              <svg viewBox="0 0 24 24" className="w-5 h-5 fill-none stroke-current stroke-2"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" /></svg>
            </button>
          </div>
        </div>
      </div>
